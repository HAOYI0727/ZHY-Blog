...
export const en: Translation = {
    ...
    [Key.learningPath]: "Learning path",
    [Key.learningPathDescription]: "Follow this sequence to build your understanding step by step",
    [Key.learningPathPrevious]: "Previous",
    [Key.learningPathNext]: "Next",
    [Key.learningPathProgress]: "Progress",
    [Key.bookmark]: "Bookmark",
    [Key.bookmarked]: "Bookmarked",
    [Key.markAsRead]: "Mark as read",
    [Key.markedAsRead]: "Read",
    [Key.updateHistory]: "Update history",
    [Key.updateHistoryDescription]: "Important changes recorded for future reference",
    [Key.feedback]: "Feedback & suggestions",
    [Key.feedbackDescription]: "Found an error, outdated content, or an idea for improvement? Let me know.",
    [Key.feedbackArticle]: "Give feedback on this article",
    [Key.reportIssue]: "Submit an issue",
