...
export const zh_hans: Translation = {
    ...
    [Key.searchKeyboardHint]: "使用 ↑↓ 选择，Enter 打开",
    [Key.openMenu]: "打开导航菜单",
    ...
    [Key.friendsDescription]: "精心整理的朋友站点。",
    [Key.welcomeSkip]: "跳过介绍",
    [Key.welcomeSkipLabel]: "跳过欢迎页并进入博客",
    [Key.welcomeHeadlineLead]: "让好奇心",
    [Key.welcomeHeadlineAccent]: "点亮知识宇宙",
    [Key.welcomeIntro]: "在代码、模型与思想之间自由漫游。这里持续记录人工智能、机器学习、软件工程与成长实践，让每次阅读都成为一次新的发现。",
    [Key.welcomeDeepContent]: "篇深度内容",
    [Key.welcomeKnowledgeAreas]: "个知识领域",
    [Key.welcomeUpdating]: "持续更新",
    [Key.welcomeAllCategories]: "全部分类",
    [Key.welcomeKnowledgePlanets]: "个知识星球",
    [Key.welcomeEnterBlog]: "进入我的博客",
    [Key.welcomeContentGuide]: "网站内容导览",
    [Key.welcomeLatestIdeas]: "最新灵感",
    [Key.welcomeViewAll]: "查看全部",
    [Key.welcomeOpenArticle]: "打开文章继续阅读",
    [Key.welcomeQuickPortal]: "快捷传送门",
    [Key.welcomeChoosePath]: "选择你的探索方式",
    [Key.welcomeArchiveDescription]: "沿着时间阅读",
    [Key.welcomeProjectsDescription]: "从想法到作品",
    [Key.welcomeTimelineDescription]: "经历与成长",
    [Key.welcomeAboutDescription]: "认识作者",
    [Key.welcomeMeetAuthor]: "认识",
    [Key.welcomeSearchTitle]: "快速找到想看的内容",
    [Key.welcomeSearchHint]: "进入后按 ⌘ / Ctrl + K 搜索全文",
    [Key.quickNavigation]: "快捷导航",
    ...
    [Key.continueReadingDescription]: "从上次离开的地方继续",
    [Key.readingProgress]: "阅读进度",
    [Key.resumeReading]: "继续",
    [Key.dismiss]: "不再提示",
    [Key.nativeShare]: "更多",
    [Key.relatedPosts]: "继续探索",
    [Key.relatedPostsDescription]: "根据本文分类与标签，为你推荐可能感兴趣的内容",
    [Key.minutesRemaining]: "分钟读完",
    [Key.readArticle]: "阅读文章",
    [Key.noPosts]: "暂无文章",
    [Key.backToParent]: "返回上级",
    [Key.subcategories]: "子分类",
    [Key.categoryEmpty]: "该分类下暂无文章",
    [Key.backToTop]: "回到顶部",
    [Key.monthArchives]: "个月份归档",
    [Key.coverImage]: "封面图",
    [Key.learningTimeline]: "学习时间线",
    [Key.learningPath]: "学习路径",
    [Key.learningPathDescription]: "按顺序完成这组文章，循序渐进地掌握主题",
    [Key.learningPathPrevious]: "上一篇",
    [Key.learningPathNext]: "下一篇",
    [Key.learningPathProgress]: "学习进度",
    [Key.bookmark]: "收藏",
    [Key.bookmarked]: "已收藏",
    [Key.markAsRead]: "标记为已读",
    [Key.markedAsRead]: "已读",
    [Key.updateHistory]: "更新记录",
    [Key.updateHistoryDescription]: "记录文章的重要变化，方便回顾与持续维护",
    [Key.feedback]: "反馈与建议",
    [Key.feedbackDescription]: "发现错误、内容过时或有改进想法？欢迎告诉我",
    [Key.feedbackArticle]: "反馈这篇文章",
    [Key.reportIssue]: "提交问题",
    [Key.albumsCount]: "个相册",
    [Key.shareToQQ]: "分享到 QQ",
    [Key.shareToWechat]: "分享到微信",
    [Key.wechat]: "微信",
    [Key.copyLink]: "复制链接",
    [Key.wechatShareQr]: "微信分享二维码",
    [Key.close]: "关闭",
    [Key.qrGenerating]: "二维码生成中…",
    [Key.articleStaysOnPage]: "当前文章会保持在原页面",
    [Key.clickToCopyLink]: "或点击复制链接",
    [Key.closeTagPanel]: "关闭标签面板",
    [Key.tagPanelHint]: "点击标签可筛选对应文章",
    [Key.searchTags]: "搜索标签",
    [Key.searchTagsPlaceholder]: "搜索标签或分类…",
    [Key.noMatchingTags]: "没有找到匹配的标签",
    [Key.allTags]: "所有标签",
    [Key.tagsCount]: "个标签",
    [Key.scanWechatQr]: "请使用微信扫描二维码分享",
    [Key.articleNavigation]: "文章浏览导航",
    [Key.musicPlayTrack]: "播放",
    [Key.musicNoLyrics]: "暂无歌词",
    [Key.musicLyricsLoading]: "加载歌词中…",
    [Key.musicJumpToLyric]: "跳转至此句",
