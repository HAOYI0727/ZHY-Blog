enum I18nKey {
    ...
    // 欢迎导航页
    welcomeSkip = "welcomeSkip",
    welcomeSkipLabel = "welcomeSkipLabel",
    welcomeHeadlineLead = "welcomeHeadlineLead",
    welcomeHeadlineAccent = "welcomeHeadlineAccent",
    welcomeIntro = "welcomeIntro",
    welcomeDeepContent = "welcomeDeepContent",
    welcomeKnowledgeAreas = "welcomeKnowledgeAreas",
    welcomeUpdating = "welcomeUpdating",
    welcomeAllCategories = "welcomeAllCategories",
    welcomeKnowledgePlanets = "welcomeKnowledgePlanets",
    welcomeEnterBlog = "welcomeEnterBlog",
    welcomeContentGuide = "welcomeContentGuide",
    welcomeLatestIdeas = "welcomeLatestIdeas",
    welcomeViewAll = "welcomeViewAll",
    welcomeOpenArticle = "welcomeOpenArticle",
    welcomeQuickPortal = "welcomeQuickPortal",
    welcomeChoosePath = "welcomeChoosePath",
    welcomeArchiveDescription = "welcomeArchiveDescription",
    welcomeProjectsDescription = "welcomeProjectsDescription",
    welcomeTimelineDescription = "welcomeTimelineDescription",
    welcomeAboutDescription = "welcomeAboutDescription",
    welcomeMeetAuthor = "welcomeMeetAuthor",
    welcomeSearchTitle = "welcomeSearchTitle",
    welcomeSearchHint = "welcomeSearchHint",
    ...
    continueReadingDescription = "continueReadingDescription",
    readingProgress = "readingProgress",
    resumeReading = "resumeReading",
    dismiss = "dismiss",
    nativeShare = "nativeShare",
    relatedPosts = "relatedPosts",
    relatedPostsDescription = "relatedPostsDescription",
    ...
    backToTop = "backToTop",
    monthArchives = "monthArchives",
    coverImage = "coverImage",
    learningTimeline = "learningTimeline",
    learningPath = "learningPath",
    learningPathDescription = "learningPathDescription",
    learningPathPrevious = "learningPathPrevious",
    learningPathNext = "learningPathNext",
    ...
    updateHistoryDescription = "updateHistoryDescription",
    feedback = "feedback",
    ...
    wechat = "wechat",
    copyLink = "copyLink",
    wechatShareQr = "wechatShareQr",
    close = "close",
    qrGenerating = "qrGenerating",
    articleStaysOnPage = "articleStaysOnPage",
    clickToCopyLink = "clickToCopyLink",
    closeTagPanel = "closeTagPanel",
    tagPanelHint = "tagPanelHint",
    searchTags = "searchTags",
    searchTagsPlaceholder = "searchTagsPlaceholder",
    noMatchingTags = "noMatchingTags",
    allTags = "allTags",
    tagsCount = "tagsCount",
    scanWechatQr = "scanWechatQr",
    articleNavigation = "articleNavigation",
    musicPlayTrack = "musicPlayTrack",
    musicNoLyrics = "musicNoLyrics",
    musicLyricsLoading = "musicLyricsLoading",
    musicJumpToLyric = "musicJumpToLyric",
